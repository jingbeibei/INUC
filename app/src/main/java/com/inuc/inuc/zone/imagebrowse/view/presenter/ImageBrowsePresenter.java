package com.inuc.inuc.zone.imagebrowse.view.presenter;
...
import com.inuc.inuc.zone.imagebrowse.view.ImageBrowseView;
    ...
    public void saveImage(){
        ...
        Picasso.with(view.getMyContext()).load(imageUrl).into(new Target() {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                // 创建目录
                File appDir = new File(Environment.getExternalStorageDirectory(), "INuc");
                if (!appDir.exists()) {
                    appDir.mkdir();
                }
