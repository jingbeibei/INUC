 ...
 */
public class UpdateReceiverTwo extends BroadcastReceiver {
    private AlertDialog.Builder mDialog;
    public static final String UPDATE_ACTION = "wuyinlei_aixinwen_two";
    ...
    public UpdateReceiverTwo() {
    }

    public UpdateReceiverTwo(boolean isShowDialog) {
        super();
