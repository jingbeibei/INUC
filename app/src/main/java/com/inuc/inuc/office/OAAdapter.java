...
public class OAAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OAAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public void setmDate(List<OANews> data) {
        this.mData = data;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
           ...
           OANews letter = mData.get(position);
            if (letter == null) {
                return;
            }
            ((ItemViewHolder) holder).Title.setText(letter.getTitle());
            ((ItemViewHolder) holder).Time.setText(letter.getTime().substring(0, 10));
    ...
    public OANews getItem(int position) {
